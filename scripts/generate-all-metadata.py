...
FORMS_IDS = [
    "1lGlXSQWDSmkR-5no-8eH2-Rfg6N-_RJh",
    "1HKPfqLDjISFhYGRq0iWoFS1zLSoB3Jv9",
    "1MtE1wmrYdboFbK3v3LWoz1hdadICvF6M",
    "1aaQuYvpCC1Ga8pfVswaAsulX6OsoUD7f",
    "1Qw6AvAlrTOK-qxoPhN1pUNx7ZACmZSeC",
    "1wNucwkiLLQ7mSgnF-LLwt2XbTNfC0o4S",
    "1Ul26pJqXolWEuSThEvjc7IXJJJucfqqR",
    "1LiRx15icXvv8GtDbroxpQOc75ANucaV6",
    "1Z3iDArUGGbWSip86H-BmVMtmgArPvwox",
    "1pI_g8dA4y4r2akmj9jOhXOdE8IdBf5WK",
    "16PcjDqmFdZ4mZagAuaONfni-Gqi7lIWL",
    "1-dxq1C8A_yCzlBih7tqmRWuSIlQJzTwG",
    "1QPez_4an9jdK7dj2p7_OnF2NmIcxuC7d",
    "1ylrv95y48VEuHIUnlvNNPCSTBDApL3hT",
    "1lEq78AvGIhx8uLmx7h6G06NTjiALTtQu",
    "1M14vBfAykMciWTIbJv7-48y7CJCn7xqZ",
    "1IR2ZfE-GowOKG4FnNX0nKLpa6lWsLFlx",
    "120zIwGtp7Khj9ycaXUGO3WVETz20tlLY",
    "1O8snhDVXTeXJ6z7BEcO71vEMdzpnTuAK",
    "1Ll_K0XhmbSCJ5QOkNHb77GU6umsN03Pq",
    "1rzzeKVdw9meLtEM4bj_fOrxRDXaBikPU",
    "1x_DbYesfVHrXTsQyyS27HF0Ci1oPDd9d",
    "1V3QJn_TVoJo2Ji1a_haPK_CXsrpsEBu0",
    "1C4FULFTqi6-X1Cua4h31h82X8P62UgHK",
    "1fp9k8WAjQhfo1QJmNTn3CYfonFnufdhz",
    "1JQWk52mL4HQQV8WYgn6qIKJKluGQEVBU",
    "1E6LA8Z3s_W-aiwZeBpQqm0vvD730K18T",
    "1hbm9RTGud3Xvha8OuKJ_JRBKQtdFfCsh",
    "1onhQk3ZY-aPcHJ1b5NiYSL7m28NDyNY-",
    "1_li72TeheJNNeP9SG-XKggDIZBac9h22",
    "1iXR7i0PzhmBSMiyaV7-klrWcVk0jFDFB",
    "1GR4DQV1xC5T8D_Hr7TWr5icQvJA7czO1",
    "1MhizAL_zfKM3ikgwMw53NZjN32wr1zw8",
    "1ytI4OXMpdOmlh9riRCwpNt8hqMX2Z5w4",
    "1AVn9XL4TuYaitTiFIabK8-_ryjCY8awL",
    "1czv981AJINsOp8Fx4hz6PPsOsYzC_030",
    "1oV7YEWL5QHAtHXPkr7BoDxx1MDLqAccJ",
    "1bOf0gXWS8E7xopW2WLLN_wW94Q_GOoSw",
    "12LMRzvrsWWNQ0_tg1C-4Ar35pKOOVcD1",
    "15TqayEyANdtpN4w3cGH6oYF0oFmAIfpz",
    "1ZRA7ncTcnBVFtdnx9f2MDbLEP7qshEzu",
    "1MRn63iDk-QCqaqGvvDZsuaX3Z8k-AX8H",
...
def generate_metadata_file(
    filename, drive_id, category, display_order, ceb_only=False, size_mb=0.1
):
...
def process_folder(
    folder_name, file_ids, category, start_order, ceb_only_default=False
):
...
def main():
    ...
    all_files += process_folder(
        "License Use", LICENSE_USE_IDS, "License Use", 1300, True
    )
    ...
    print(
        "2. Deploy: sf project deploy start --metadata-dir src/main/default/customMetadata --target-org cvma"
    )
